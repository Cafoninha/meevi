...
function StatisticsSection() {
  const { dogs } = useDogs()
  const { entries: diaryEntries, loading: entriesLoading } = useDiaryEntries()
        ...
        <>
          ...
          <Card className="p-4 sm:p-6">
            <h3 className="font-semibold text-sm sm:text-base mb-3 sm:mb-4">
              Atividade dos Últimos {filters.dateRange === "7days" ? "7" : filters.dateRange === "30days" ? "30" : "7"}{" "}
              Dias
            </h3>
